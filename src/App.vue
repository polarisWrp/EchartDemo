...
<script setup lang="ts">
  ...
  import * as echarts from 'echarts' //echarts 5用法
  import './assets/china.js'
  import { geoCoordMap, GeoItem } from './assets/geoMap'
